<template>
    <div>
    <div class="row row-space-12 pt-50 mt-50">
        <div class="col-xl-12 ">
          <!-- <div class="row"> -->

            <h3 >Frequently Asked Questions</h3>
<h4> What are Razor Synths? </h4>
<p>Razor Synths allow you to mint synthetic tokens which can track any asset in the world.</p>
...
<p>Those who want to open a short position create a CDP (Collateralized Debt Postion) against the datafeed of their choice. They collateralize using ether and borrow desired synthetic asset. They must pay back the debt in order to get their collateral back.
</p>
<h4> Is there any interest charged? </h4>
<p>There is currently no interest charged for CDPs.
</p>

            <h4> How to open a short position?</h4>
            <p> Creating a CDP using this app backed by Ether will mint the synthetic tokens. You can sell these ERC20 tokens to anyone to open a "short" position. In the "Mint" form, enter the amount of ether you want to collateralize with and click "Mint". A new CDP will be opened with 500% Collateral ratio. </p>

            <h4> How to open a long position? </h4>
            <p> Buy the synthetic ERC20 tokens from anyone to open a long position. You can sell them later to close your position. </p>

            <h4> What is the minimum collateral ratio? </h4>
